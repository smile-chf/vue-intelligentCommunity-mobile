  ...
  <div style="background: #F6F6F6;width: 100%;height: 100%">
    <van-form @submit="onSubmit" style="background: #fff">
      <div class="unit">
        ...
        <van-field v-model="formdata.title" type="textarea" rows="2" placeholder="请输入联盟活动标题" />
      </div>
      <div class="unit">
        <van-field
          disabled
      ...
      <div class="unit">
        <van-field label="活动地址" v-model="formdata.site" input-align="right" placeholder="请输入活动地址" />
      </div>
      <div class="unit">
        <van-field label="举办单位" v-model="formdata.unit" input-align="right" placeholder="请输入举办单位" />
      </div>
      <div class="unit">
        <van-field
          label="活动积分"
